...
curr_path = os.getcwd()
# Where to find data
tf.app.flags.DEFINE_string('data_path', os.path.join(curr_path, 'metadata', 'train_*'),
                           'Path expression to tf.Example datafiles. Can include wildcards to access multiple datafiles.')
tf.app.flags.DEFINE_string('vocab_path', os.path.join(curr_path, 'metadata', 'vocab'),
...
tf.app.flags.DEFINE_string('log_root', os.path.join(curr_path, 'log'), 'Root directory for all logging.')
tf.app.flags.DEFINE_string('exp_name', 'goo',
...
tf.app.flags.DEFINE_integer('save_summaries_secs', 120, 'save_summaries_secs')
tf.app.flags.DEFINE_integer('save_model_secs', 120, 'save_model_secs')
...
def run_training(model, batcher, sess_context_manager, sv, summary_writer):
    ...
    with sess_context_manager as sess:
        ...
        while True:  # repeats until interrupted
            ...
            tf.logging.info('step: {}'.format(train_step))  # print the loss to screen
