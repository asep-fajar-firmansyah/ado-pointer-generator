...
class Example(object):
    ...
    def __init__(self, article, abstract_sentences, vocab, hps):
        ...
        # store the length after truncation but before padding， sequence real length
...
class Batch(object):
    ...
    def init_encoder_seq(self, example_list, hps):
        ...
        #   padding index is 0, real len are 1
...
class Batcher(object):
    ...
    BATCH_QUEUE_MAX = 2  # max number of batches the batch_queue can hold
    ...
    def __init__(self, data_path, vocab, hps, single_pass):
        ...
        if single_pass:
            ...
            self._num_example_q_threads = 4  # num threads to fill example queue
            self._num_batch_q_threads = 16  # num threads to fill batch queue
            self._bucketing_cache_size = 2  # how many batches-worth of examples to load into cache before bucketing
